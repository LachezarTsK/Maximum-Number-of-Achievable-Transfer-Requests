 ...
 * @param {number[][]} transferRequests
 * @return {number}
 */
var maximumRequests = function (numberOfBuildings, transferRequests) {
 ...
 * @return {boolean}
 */
function allBuildingsAreBalanced(balance) {
 ...
 * @return {number}
 */
function moveBalanceChangingTransferRequestsToTheFront(transferRequests) {
